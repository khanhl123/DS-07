...
export default function DashboardLayout({ filterProps, sidebarOpen, onToggleSidebar, children }) {
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-[linear-gradient(180deg,#f7f0e8_0%,#f0e4d8_100%)]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main
          id="main-content"
          className="flex-1 overflow-y-auto bg-[radial-gradient(circle_at_top_left,_rgba(231,111,81,0.1),_transparent_22%),radial-gradient(circle_at_95%_4%,_rgba(42,157,143,0.1),_transparent_18%),linear-gradient(180deg,#f9f4ee_0%,#f2e7db_100%)]"
          role="main"
